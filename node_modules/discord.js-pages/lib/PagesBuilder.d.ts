import { ColorResolvable, CommandInteraction, GuildMember, Message, MessageActionRow, MessageActionRowComponent, MessageButton, MessageEmbed, MessageOptions, MessageSelectMenu } from 'discord.js';
...
export declare class PagesBuilder extends MessageEmbed {
     ...
     */
    setPage(pageNumber: number): Promise<any | Message | APIMessage>;
    /**
